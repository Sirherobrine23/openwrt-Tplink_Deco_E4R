...
int netifd_config_get_mode(char *conf_mode, int mode_size)
{
    ...
    strncpy(opt_name, "wanDetect.@wanDetection[0].mode", sizeof(opt_name));
    ...
    strncpy(conf_mode, ptr.o->v.string, mode_size - 1);
