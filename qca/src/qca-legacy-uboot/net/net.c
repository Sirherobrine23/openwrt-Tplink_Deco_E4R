...
restart:
		...
		else
		{
			...
			if(flag == 1)
			{
                                ...
                                ath_reg_rmw_set(GPIO_OUT_ADDRESS, (1 << 1) + (1 << 21));//e4 yellow
                                ath_reg_rmw_clear(GPIO_OUT_ADDRESS, (2 << 1));//e4 red
#else
			...
			else
			{
                                ...
                                ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 21));//e4 green
                                ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 2));//e4 blue
                                ath_reg_rmw_clear(GPIO_OUT_ADDRESS, (1 << 1) + (1 << 21));//e4 yellow
                                ath_reg_rmw_set(GPIO_OUT_ADDRESS, (2 << 1));//e4 red
#else
                ...
                if (webfailsafe_file_check_ok){
                        ...
                        if(do_http_upgrade(NetBootFileXferSize, webfailsafe_upgrade_type) >= 0){
                                ...
                                //upgrade success, turn on white light
#if defined(CONFIG_PRODUCT_E4)
                                ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 1));//e4 red
                                ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 21));//e4 green
                                ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 2));//e4 blue
                                ath_reg_rmw_set(GPIO_OUT_ADDRESS, (1 << 1) + (1 << 21) + (1 << 2));//e4 white
                                ath_reg_rmw_clear(GPIO_OUT_ADDRESS, (1 << 1) + (1 << 21) + (1 << 2));//e4 white
#else
                                ath_reg_rmw_set(GPIO_OE_ADDRESS, (1 << 1));//red
                                ath_reg_rmw_set(GPIO_OE_ADDRESS, (1 << 7));//green
				...
				udelay(500*1000);
                        ...
                        //upgrade fail, turn on red light
                        ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 7));//clear green
...
fail:
	//fail, turn on red light
	ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 7));//clear green
	ath_reg_rmw_set(GPIO_OE_ADDRESS, (1 << 7));//clear green
        return(-1);
}
